...
console.log(bessie, neigh, dolly, babe, little);
// 3. Little the chicken had to go back to the coop, so now we're left with three. Let's use color variables of blackAndWhite, black, and pink.
const newNumFarmAnimals = 'cow sheep pig chicken'
const [blackAndWhite, black, pink ]= newNumFarmAnimals.split(' ');
...
const latestColors = ['indigo'];
const [indg]= latestColors;
console.log(indg);
